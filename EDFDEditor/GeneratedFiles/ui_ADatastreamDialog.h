...
public:
    ...
    void setupUi(QDialog *ADatastreamDialog_dialogClass)
    {
        if (ADatastreamDialog_dialogClass->objectName().isEmpty())
            ADatastreamDialog_dialogClass->setObjectName(QStringLiteral("ADatastreamDialog_dialogClass"));
        ...
        inc_data_list->setObjectName(QStringLiteral("inc_data_list"));
        ...
        out_data_list->setObjectName(QStringLiteral("out_data_list"));
    ...
    {
        ADatastreamDialog_dialogClass->setWindowTitle(QApplication::translate("ADatastreamDialog_dialogClass", "Datastream editor", 0));
        label->setText(QApplication::translate("ADatastreamDialog_dialogClass", "Incoming data", 0));
        label_2->setText(QApplication::translate("ADatastreamDialog_dialogClass", "Outgoing data", 0));
        cancel_button->setText(QApplication::translate("ADatastreamDialog_dialogClass", "Cancel", 0));
        done_button->setText(QApplication::translate("ADatastreamDialog_dialogClass", "Done", 0));
    } // retranslateUi
