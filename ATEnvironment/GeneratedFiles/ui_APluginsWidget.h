...
public:
    ...
    {
        APluginsWidget->setWindowTitle(QApplication::translate("APluginsWidget", "ATEnvironment - Plugins", 0));
        QTreeWidgetItem *___qtreewidgetitem = treePlugins->headerItem();
        ___qtreewidgetitem->setText(2, QApplication::translate("APluginsWidget", "Path", 0));
        ___qtreewidgetitem->setText(1, QApplication::translate("APluginsWidget", "Description", 0));
        ___qtreewidgetitem->setText(0, QApplication::translate("APluginsWidget", "Name", 0));
        pushButton_2->setText(QApplication::translate("APluginsWidget", "Cancel", 0));
        pushButton->setText(QApplication::translate("APluginsWidget", "OK", 0));
    } // retranslateUi
